// Copied from https://github.com/tilgovi/dom-anchor-text-position/blob/master/src/range-to-string.js

/**
 * Return the next node after `node` in a tree order traversal of the document.
 */
function nextNode(node: Node, skipChildren = false) {
...
function firstNode(range: Range) {
...
function firstNodeAfter(range: Range) {
...
function forEachNodeInRange(range: Range, cb: (n: Node) => any) {
 ...
 */
export default function rangeToString(range: Range) {
